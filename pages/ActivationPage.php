    ...
    public function render(): string
    {
            ...
            if ($this->checkQueryStringUser('activation')) {
                ...
                if($this->verify){
                    ...
                    $this->user->delete();
                    // set the alert
                    $this->alert->setText(sprintf($this->_('Thank you for your feedback! The corresponding user account has been permanently deleted and you will not receive any further mails from %s.'), $this->wire('pages')->get('/')->httpUrl));
                    $this->alert->setCSSClass('alert_successClass');
                }
            } else {
