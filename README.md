...
- PHP 8.0 or newer
- FrontendForms 2.1.52 or newer: Please download and install it from the [modules directory](https://processwire.com/modules/frontend-forms/) first.
...
- Usage of all the benefits of [FrontendForms](https://processwire.com/modules/frontend-forms/) (fe. CAPTCHA, various security settings, support for UIKit and Bootstrap framework, ...)
